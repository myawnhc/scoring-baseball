...
The complete guide to keeping score at a baseball game — whether you're using a pencil and a paper scorecard, or the [BaseballScorer](https://apps.apple.com/app/id6761680617) app on your iPad.
...
If you're new to scoring, start with [The Basics]({{< relref "/docs/basics" >}}) — it'll take you from zero to confidently scoring a game in about 20 minutes of reading.
